{{ config(
    ...
    pre_hook= [
        "{{ copy_into_macro('bronze_zone_dev.sasreference.sasreference_stage', 'bronze_zone_dev.sasreference.syspublications_transient', false, '(?i)DBO.syspublications/.*.parquet') }}",
