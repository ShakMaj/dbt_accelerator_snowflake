{{ config(
    ...
    pre_hook= [
        "{{ copy_into_macro('bronze_zone_dev.sasreference.sasreference_stage', 'bronze_zone_dev.sasreference.reqbillingfreq_transient', false, '(?i)DBO.ReqBillingFreq/.*.parquet') }}",
