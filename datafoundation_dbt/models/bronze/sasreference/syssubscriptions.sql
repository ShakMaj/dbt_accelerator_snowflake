{{ config(
    ...
    pre_hook= [
        "{{ copy_into_macro('bronze_zone_dev.sasreference.sasreference_stage', 'bronze_zone_dev.sasreference.syssubscriptions_transient', false, '(?i)DBO.syssubscriptions/.*.parquet') }}",
