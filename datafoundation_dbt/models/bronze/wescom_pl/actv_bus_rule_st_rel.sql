{{ config(
    ...
    pre_hook= [
        "{{ copy_into_macro('bronze_zone_dev.wescom_pl.wescom_pl_stage', 'bronze_zone_dev.wescom_pl.actv_bus_rule_st_rel_transient', false, '(?i)TDB2WPLQ.ACTV_BUS_RULE_ST_REL/.*.parquet') }}",
