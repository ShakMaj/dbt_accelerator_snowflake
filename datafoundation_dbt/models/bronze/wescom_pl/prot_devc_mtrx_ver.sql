{{ config(
    ...
    pre_hook= [
        "{{ copy_into_macro('bronze_zone_dev.wescom_pl.wescom_pl_stage', 'bronze_zone_dev.wescom_pl.prot_devc_mtrx_ver_transient', false, '(?i)TDB2WPLQ.PROT_DEVC_MTRX_VER/.*.parquet') }}",
