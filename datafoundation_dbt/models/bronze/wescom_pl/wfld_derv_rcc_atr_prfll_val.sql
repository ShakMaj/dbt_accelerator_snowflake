{{ config(
    ...
    pre_hook= [
        "{{ copy_into_macro('bronze_zone_dev.wescom_pl.wescom_pl_stage', 'bronze_zone_dev.wescom_pl.wfld_derv_rcc_atr_prfll_val_transient', false, '(?i)TDB2WPLQ.WFLD_DERV_RCC_ATR_PRFLL_VAL/.*.parquet') }}",
