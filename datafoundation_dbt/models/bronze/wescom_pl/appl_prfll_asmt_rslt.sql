{{ config(
    ...
    pre_hook= [
        "{{ copy_into_macro('bronze_zone_dev.wescom_pl.wescom_pl_stage', 'bronze_zone_dev.wescom_pl.appl_prfll_asmt_rslt_transient', false, '(?i)TDB2WPLQ.APPL_PRFLL_ASMT_RSLT/.*.parquet') }}",
