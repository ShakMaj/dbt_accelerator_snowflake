{{ config(
    ...
    pre_hook= [
        "{{ copy_into_macro('bronze_zone_dev.wescom_pl.wescom_pl_stage', 'bronze_zone_dev.wescom_pl.prch_prdt_info_state_rel_transient', false, '(?i)TDB2WPLQ.PRCH_PRDT_INFO_STATE_REL/.*.parquet') }}",
