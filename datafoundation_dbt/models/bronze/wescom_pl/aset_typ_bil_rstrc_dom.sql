{{ config(
    ...
    pre_hook= [
        "{{ copy_into_macro('bronze_zone_dev.wescom_pl.wescom_pl_stage', 'bronze_zone_dev.wescom_pl.aset_typ_bil_rstrc_dom_transient', false, '(?i)TDB2WPLQ.ASET_TYP_BIL_RSTRC_DOM/.*.parquet') }}",
