{{ config(
    ...
    pre_hook= [
        "{{ copy_into_macro('bronze_zone_dev.wescom_pl.wescom_pl_stage', 'bronze_zone_dev.wescom_pl.rel_wfld_pol_sym_transient', false, '(?i)TDB2WPLQ.REL_WFLD_POL_SYM/.*.parquet') }}",
