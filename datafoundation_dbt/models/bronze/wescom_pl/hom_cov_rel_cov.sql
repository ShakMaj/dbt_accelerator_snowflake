{{ config(
    ...
    pre_hook= [
        "{{ copy_into_macro('bronze_zone_dev.wescom_pl.wescom_pl_stage', 'bronze_zone_dev.wescom_pl.hom_cov_rel_cov_transient', false, '(?i)TDB2WPLQ.HOM_COV_REL_COV/.*.parquet') }}",
