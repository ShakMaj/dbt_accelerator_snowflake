{{ config(
    ...
    pre_hook= [
        "{{ copy_into_macro('bronze_zone_dev.wescom_pl.wescom_pl_stage', 'bronze_zone_dev.wescom_pl.undly_unit_risk_transient', false, '(?i)TDB2WPLQ.UNDLY_UNIT_RISK/.*.parquet') }}",
