{{ config(
    ...
    pre_hook= [
        "{{ copy_into_macro('bronze_zone_dev.wescom_pl.wescom_pl_stage', 'bronze_zone_dev.wescom_pl.add_int_veh_tmplt_transient', false, '(?i)TDB2WPLQ.ADD_INT_VEH_TMPLT/.*.parquet') }}",
